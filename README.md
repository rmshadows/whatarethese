...
|[JavaApplicationLauncher](https://github.com/rmshadows/whatarethese/releases/tag/JavaApplicationLauncher_v1.0)|C++|Windows|v1.0|用于加载我用Jlink打包的Java或JavaFX桌面应用，其实就是执行CMD命令而已|
